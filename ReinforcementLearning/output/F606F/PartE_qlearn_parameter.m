% Testing 2
cliffworld;
[v, pi, all] = qLearning(model,1000,50000,...
                    'constant',0.5,...
                    'constant',0.1);
[v2, pi2, all2] = qLearning(model,1000,50000,...
                    'constant',0.2,...
                    'constant',0.1);
[v3, pi3, all3] = qLearning(model,1000,50000,...
                    'constant',0.05,...
                    'constant',0.1);
[v4, pi4, all4] = qLearning(model,1000,50000,...
                    'constant',0.0001,...
                    'constant',0.1);
...
[v5, pi5, all5] = qLearning(model,1000,50000,...
                    'constant',0.1,...
                    'constant',0.5);
[v6, pi6, all6] = qLearning(model,1000,50000,...
                    'constant',0.1,...
                    'constant',0.2);
[v7, pi7, all7] = qLearning(model,1000,50000,...
                    'constant',0.1,...
                    'constant',0.05);
[v8, pi8, all8] = qLearning(model,1000,50000,...
                    'constant',0.1,...
                    'constant',0.0001);
